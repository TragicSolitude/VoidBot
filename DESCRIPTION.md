...
inclusive.
- `!teams [n]` **BETA VERY BUGGY** Creates `[n]` temporary channels that
represent each of the [n]`teams. All members currently in your voice channel
are then randomly and evenly placed into the team channels. You cannot create
more teams than there are members to be moved into said teams; there has to be
